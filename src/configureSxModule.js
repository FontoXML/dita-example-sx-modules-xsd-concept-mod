define([
	...
	return function configureSxModule (sxModule) {
		...
		configureContextualOperations(sxModule, 'self::section[parent::conbodydiv or (parent::conbody and preceding-sibling::*[1][self::section or self::example or self::conbodydiv])]', [
			{ name: ':section-insert-title' },
			{ name: ':contextual-delete-section' }
		]);

		// example in conbody/conbodydiv
		configureContextualOperations(sxModule, 'self::example[parent::conbodydiv or (parent::conbody and preceding-sibling::*[1][self::section or self::example or self::conbodydiv])]', [
		...
		configureAsFrame(sxModule, 'self::conbodydiv', t('body division'), {
			contextualOperations: [
				{ name: ':contextual-unwrap-conbodydiv' }
			],
		...
		configureAsFrame(sxModule, 'self::concept[parent::*[fonto:dita-class(., "topic/topic")]]', undefined, {
			defaultTextContainer: 'conbody',
			blockFooter: [
				createRelatedNodesQueryWidget('./related-links')
			],
